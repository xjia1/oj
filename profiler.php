...
function profiler_dump()
{
  ...
  $instruments = profiler_instrument_read('fetchRealName').' '.profiler_instrument_read('Record::getTimeCost').' '.profiler_instrument_read('Record::getMemoryCost').' '.profiler_instrument_read('Record::getScore');
